...
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'pdf_documents') THEN
...
-- Create updated_at trigger for pdf_documents (only if it doesn't exist)
